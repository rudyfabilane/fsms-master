...
public interface IConnectivityManager extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.net.IConnectivityManager {
        ...
        public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException {
            switch (code) {
                ...
                case TRANSACTION_startLegacyVpn: {
                    ...
                    VpnProfile _arg0;
                    if ((0 != data.readInt())) {
                        _arg0 = VpnProfile.CREATOR.createFromParcel(data);
                    } else {
                        _arg0 = null;
                    }
                ...
                case TRANSACTION_getLegacyVpnInfo: {
                    data.enforceInterface(DESCRIPTOR);
                    LegacyVpnInfo _result = this.getLegacyVpnInfo();
                    reply.writeNoException();
                    if ((_result != null)) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
        ...
        private static class Proxy implements android.net.IConnectivityManager {
            ...
            @Override
            public android.os.ParcelFileDescriptor establishVpn(VpnConfig config) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
            ...
            @Override
            public void startLegacyVpn(VpnProfile profile) throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
            ...
            @Override
            public LegacyVpnInfo getLegacyVpnInfo() throws android.os.RemoteException {
                android.os.Parcel _data = android.os.Parcel.obtain();
                android.os.Parcel _reply = android.os.Parcel.obtain();
