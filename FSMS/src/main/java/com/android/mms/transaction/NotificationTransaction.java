...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public NotificationTransaction(
        ...
        try {
            ...
            try {
                group = com.rojangames.freetextph.mmssms.Transaction.settings.getGroup();
            } catch (Exception e) {
            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    Uri uri = p.persist(pdu, Inbox.CONTENT_URI, true,
                            com.rojangames.freetextph.mmssms.Transaction.settings.getGroup(), null);
                    ...
                    mContext.sendBroadcast(new Intent(com.rojangames.freetextph.mmssms.Transaction.NOTIFY_OF_MMS));
                }
            }
