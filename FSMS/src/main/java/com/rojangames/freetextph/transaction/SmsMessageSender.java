...
import com.rojangames.freetextph.receiver.SmsReceiver;
...
public class SmsMessageSender implements MessageSender {
    ...
    private boolean queueMessage(long token) throws MmsException {
        ...
        mContext.sendBroadcast(new Intent("com.rojangames.freetextph.transaction.SEND_MESSAGE", null, mContext, SmsReceiver.class));
        return false;
    }
