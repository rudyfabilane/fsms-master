package com.rojangames.freetextph.transaction;
...
import com.rojangames.freetextph.data.ContactHelper;
...
import com.rojangames.freetextph.receiver.WearableIntentReceiver;
import com.rojangames.freetextph.ui.MainActivity;
import com.rojangames.freetextph.ui.ThemeManager;
import com.rojangames.freetextph.ui.messagelist.MessageItem;
import com.rojangames.freetextph.ui.popup.QKComposeActivity;
...
public class NotificationManager {
    public static final String ACTION_MARK_READ = "com.rojangames.freetextph.MARK_READ";
    public static final String ACTION_MARK_SEEN = "com.rojangames.freetextph.MARK_SEEN";
    ...
    private static void buildSingleMessageNotification(final Context context, ArrayList<MessageItem> messages, long threadId,
        ...
        switch (privateNotifications) {
            ...
            case 1: //Hide message
                ...
                title = message.mContact;
                Log.i(TAG, "ads case 1");
                break;
            case 2: //Hide sender & message
                body = sRes.getString(R.string.new_message);
                title = "QKSMS";
                Log.i(TAG, "ads case 2");
                break;
            default:
                body = message.mBody;
                title = message.mContact;
        ...
        builder.setContentTitle(title)
                ...
                .addAction(R.drawable.ic_accept, sRes.getString(R.string.mark_read), readPI)
