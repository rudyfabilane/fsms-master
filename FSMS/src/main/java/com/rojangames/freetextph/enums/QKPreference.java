package com.rojangames.freetextph.enums;
...
public enum QKPreference {
    ...
    // General
    SEND_OPTIONS("pref_key_enable_sim",false),
    ...
    ENTER_BUTTON("pref_key_enter_button", "1"),
    ...
    // QK Reply
    QK_REPLY("pref_key_quickreply_enabled_", false),
    TAP_DISMISS("pref_key_quickreply_dismiss_", false),
