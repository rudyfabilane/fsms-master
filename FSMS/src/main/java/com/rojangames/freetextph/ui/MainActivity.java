package com.rojangames.freetextph.ui;
...
import com.rojangames.freetextph.common.QKRateSnack;
import com.rojangames.freetextph.common.google.DraftCache;
import com.rojangames.freetextph.common.utils.KeyboardUtils;
import com.rojangames.freetextph.common.utils.MessageUtils;
import com.rojangames.freetextph.common.utils.Units;
...
import com.rojangames.freetextph.receiver.IconColorReceiver;
...
import com.rojangames.freetextph.ui.conversationlist.ConversationListFragment;
...
import com.rojangames.freetextph.ui.messagelist.MessageListFragment;
import com.rojangames.freetextph.ui.popup.QKReplyActivity;
import com.rojangames.freetextph.ui.search.SearchFragment;
import com.rojangames.freetextph.ui.settings.SettingsFragment;
import com.rojangames.freetextph.ui.view.slidingmenu.SlidingMenu;
import com.rojangames.freetextph.ui.welcome.WelcomeActivity;
...
public class MainActivity extends QKActivity implements SlidingMenu.SlidingMenuListener {
    ...
    private String SUPPORT_URL = "https://s3.amazonaws.com/supportpage/help.html";
    /**
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_help_support:
                startBrowserIntent(SUPPORT_URL);
                break;
            case R.id.menu_share:
                Intent sharingIntent = new Intent(android.content.Intent.ACTION_SEND);
                sharingIntent.setType("text/plain");
                String shareBody = getString(R.string.menu_share_share_msg);
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Free TexT To All Networks!");
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, shareBody);
                try {
                    startActivity(Intent.createChooser(sharingIntent, "Share Freedom SMS"));
                }catch (Exception x){
