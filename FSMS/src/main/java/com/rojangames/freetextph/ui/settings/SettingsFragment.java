package com.rojangames.freetextph.ui.settings;
...
import com.rojangames.freetextph.common.ListviewHelper;
...
import com.rojangames.freetextph.receiver.NightModeAutoReceiver;
...
import com.rojangames.freetextph.ui.dialog.BlockedNumberDialog;
import com.rojangames.freetextph.ui.dialog.BubblePreferenceDialog;
import com.rojangames.freetextph.ui.dialog.QKDialog;
import com.rojangames.freetextph.ui.view.colorpicker.ColorPickerDialog;
import com.rojangames.freetextph.ui.view.colorpicker.ColorPickerSwatch;
...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener,
    ...
    public static final String CATEGORY_SEND_OPTIONS = "pref_key_enable_sim";
    // Sub-categories
    ...
    public static final String QUICKREPLY = "pref_key_quickreply_enabled_";
    public static final String QUICKREPLY_TAP_DISMISS = "pref_key_quickreply_dismiss_";
    ...
    public static final String FACEBOOK = "pref_key_fb";
    public static final String SUPPORT = "pref_key_support";
    ...
    public static final String FACEBOOK_URL = "https://www.facebook.com/freedomsms";
    public static String FACEBOOK_PAGE_ID = "freedomsms";

    //    public static final String SUPPORT_URL = "https://s3.amazonaws.com/supportpage/help.html";
...
/*        Preference icon = findPreference(ICON);
        ...
        try {
            //this will be null if other items are selected so make sure to handle it properly
            //or put this at the end of other codes
            //sending options
            CheckBoxPreference pref = (CheckBoxPreference) findPreference("pref_key_enable_sim");

            if (isSentViaHttp(mContext)) {
                pref.setChecked(false);
                pref.setSummary(R.string.pref_send_options_summary_sim_mode);
            } else {
                pref.setChecked(true);
                pref.setSummary(R.string.pref_send_options_summary_free_mode);
            }
        } catch (Exception x) {
            x.printStackTrace();
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        switch (key) {
            ...
            case MAX_MMS_ATTACHMENT_SIZE:
                ...
                break;
            case CATEGORY_SEND_OPTIONS:
                if ((Boolean) newValue) {
                    new QKDialog()
                            .setContext(mContext)
                            .setTitle(R.string.warning_title)
                            .setMessage("Are you sure you want to enable SIM mode? Charges may apply")
                            .setPositiveButton(R.string.yes, v -> {
                                //Enabling sim mode
                                mPrefs = mContext.getPrefs();
                                ...
                                mContext.makeToast(R.string.pref_change_notification);
                                ((CheckBoxPreference) preference).setChecked(true);
                                CheckBoxPreference pref = (CheckBoxPreference) findPreference("pref_key_enable_sim");
                                pref.setSummary(R.string.pref_send_options_summary_free_mode);
                            })
                ...
                CheckBoxPreference pref = (CheckBoxPreference) findPreference("pref_key_enable_sim");
                pref.setSummary(R.string.pref_send_options_summary_sim_mode);
                mContext.makeToast(R.string.freetext_on);
                break;
        }
