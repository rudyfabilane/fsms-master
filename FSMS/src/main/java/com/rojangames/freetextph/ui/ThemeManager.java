...
import com.rojangames.freetextph.ui.view.colorpicker.ColorPickerPalette;
...
public class ThemeManager {
    ...
    public static final int DEFAULT_COLOR = 0xff0277bd;
                ...
                .setPositiveButton(R.string.okay, v -> {
                    ...
                    for (int i = 0; i < colors.length; i++) {
                        String componentClassName = String.format(
                                "com.rojangames.freetextph.ui.MainActivity-%s", colors[i]
                        );
