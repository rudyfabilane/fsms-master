...
package com.rojangames.freetextph.ui.widget;
...
public class WidgetProvider extends AppWidgetProvider {
    public static final String ACTION_NOTIFY_DATASET_CHANGED = "com.rojangames.freetextph.intent.action.ACTION_NOTIFY_DATASET_CHANGED";
